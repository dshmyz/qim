-- 迁移 002: 更新数据库结构以匹配 OIM Server 最新 Schema
-- 适用于: MySQL 5.7+, TiDB
-- 执行前建议: 备份整个数据库
...
-- 用户数字账号生成器
CREATE TABLE IF NOT EXISTS `w_user_number` (
...
-- 用户头像设置
CREATE TABLE IF NOT EXISTS `w_user_head` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 用户密保问题
CREATE TABLE IF NOT EXISTS `w_user_security_question` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `userId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '用户ID',
...
-- 角色功能关联表
CREATE TABLE IF NOT EXISTS `m_role_function` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `roleId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '角色ID',
...
-- 群号码生成器
CREATE TABLE IF NOT EXISTS `w_group_number` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `createdDateTime` VARCHAR(32) NOT NULL DEFAULT '0001-01-01 00:00:00' COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
-- 群成员表
CREATE TABLE IF NOT EXISTS `w_group_member` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 入群设置表
CREATE TABLE IF NOT EXISTS `w_group_join_setting` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 入群申请表
CREATE TABLE IF NOT EXISTS `w_group_join_apply` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 群分组表
CREATE TABLE IF NOT EXISTS `w_group_category` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `userId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '用户ID',
...
-- 群头像表
CREATE TABLE IF NOT EXISTS `w_group_head` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 群关系表
CREATE TABLE IF NOT EXISTS `w_group_relation` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `userId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '用户ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 群公告表
CREATE TABLE IF NOT EXISTS `w_group_notice` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 邀请入群申请表
CREATE TABLE IF NOT EXISTS `w_group_invite_apply` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 入群验证问题表
CREATE TABLE IF NOT EXISTS `w_group_join_verify_question` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 入群验证答案表
CREATE TABLE IF NOT EXISTS `w_group_join_verify_answer` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 单聊消息记录表
CREATE TABLE IF NOT EXISTS `im_user_chat_content` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 群聊消息记录表
CREATE TABLE IF NOT EXISTS `im_group_chat_content` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `messageKey` VARCHAR(80) NOT NULL DEFAULT '' COMMENT '消息key',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 最近会话表
CREATE TABLE IF NOT EXISTS `im_recent_chat` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `userId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '用户ID',
...
-- 单聊未读计数表
CREATE TABLE IF NOT EXISTS `im_user_chat_unread` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `receiveUserId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '接收者ID',
  `sendUserId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '发送者ID',
...
-- 群聊未读计数表
CREATE TABLE IF NOT EXISTS `im_group_chat_unread` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `groupId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '群ID',
...
-- 单聊会话项表
CREATE TABLE IF NOT EXISTS `im_user_chat_item` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 群聊会话项表
CREATE TABLE IF NOT EXISTS `im_group_chat_item` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 联系人关系表
CREATE TABLE IF NOT EXISTS `w_contact_relation` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 联系人分组表
CREATE TABLE IF NOT EXISTS `w_contact_category` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 添加好友申请表
CREATE TABLE IF NOT EXISTS `w_contact_add_apply` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `applyUserId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '请求用户ID',
...
-- 好友验证问题表
CREATE TABLE IF NOT EXISTS `w_contact_add_verify_question` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `userId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '用户ID',
  `question` VARCHAR(200) NOT NULL DEFAULT '' COMMENT '问题',
  PRIMARY KEY (`id`),
...
-- 好友验证答案表
CREATE TABLE IF NOT EXISTS `w_contact_add_verify_answer` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `userId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '用户ID',
  `questionId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '问题ID',
  `answer` VARCHAR(200) NOT NULL DEFAULT '' COMMENT '答案',
...
-- 防骚扰设置表
CREATE TABLE IF NOT EXISTS `w_contact_harass_setting` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `userId` VARCHAR(40) NOT NULL DEFAULT '' COMMENT '用户ID',
...
-- 通用文件表
CREATE TABLE IF NOT EXISTS `base_file_data` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `rootPath` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '根目录',
  `nodePath` VARCHAR(300) NOT NULL DEFAULT '' COMMENT '节点目录',
  `fullPath` VARCHAR(800) NOT NULL DEFAULT '' COMMENT '完整路径(不含文件名)',
...
-- 图片表
CREATE TABLE IF NOT EXISTS `base_image_data` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `rootPath` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '根目录',
  `nodePath` VARCHAR(300) NOT NULL DEFAULT '' COMMENT '节点目录',
  `fullPath` VARCHAR(800) NOT NULL DEFAULT '' COMMENT '完整路径(不含文件名)',
...
-- 用户头像文件表
CREATE TABLE IF NOT EXISTS `base_user_head_data` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `rootPath` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '根目录',
  `nodePath` VARCHAR(300) NOT NULL DEFAULT '' COMMENT '节点目录',
  `fullPath` VARCHAR(800) NOT NULL DEFAULT '' COMMENT '完整路径(不含文件名)',
...
-- 群头像文件表
CREATE TABLE IF NOT EXISTS `base_group_head_data` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
  `rootPath` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '根目录',
  `nodePath` VARCHAR(300) NOT NULL DEFAULT '' COMMENT '节点目录',
  `fullPath` VARCHAR(800) NOT NULL DEFAULT '' COMMENT '完整路径(不含文件名)',
...
-- 客户端版本表
CREATE TABLE IF NOT EXISTS `setting_app_client` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 多端在线策略表
CREATE TABLE IF NOT EXISTS `setting_multiple_online_strategy` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 文本通知表
CREATE TABLE IF NOT EXISTS `w_text_notice` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 用户通知记录表
CREATE TABLE IF NOT EXISTS `w_user_text_notice` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 敏感词过滤表
CREATE TABLE IF NOT EXISTS `im_words_filter` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 服务端动作信息表
CREATE TABLE IF NOT EXISTS `server_action_info` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
-- 服务器地址表
CREATE TABLE IF NOT EXISTS `server_address` (
  `id` VARCHAR(40) NOT NULL COMMENT '主键ID',
...
WHERE TABLE_SCHEMA = DATABASE() 
  AND TABLE_NAME LIKE 'w_%' OR TABLE_NAME LIKE 'm_%' OR TABLE_NAME LIKE 'im_%' OR TABLE_NAME LIKE 'base_%' OR TABLE_NAME LIKE 'setting_%' OR TABLE_NAME LIKE 'server_%';
