    ...
    <div class="menu-wrapper">
      <el-menu :default-active="activeMenu" :collapse="collapsed" router class="sidebar-menu">
        ...
        <el-sub-menu index="user-group">
          ...
          <el-menu-item index="/admin/users" v-permission="'user:read'">
            <el-icon><User /></el-icon>
            <template #title>用户管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/organization" v-permission="'organization:read'">
            <el-icon><School /></el-icon>
            <template #title>组织架构</template>
          </el-menu-item>
          <el-menu-item index="/admin/roles" v-permission="'role:read'">
            <el-icon><Key /></el-icon>
        ...
        <el-sub-menu index="chat-group">
          ...
          <el-menu-item index="/admin/groups" v-permission="'group:read'">
            <el-icon><UserFilled /></el-icon>
            <template #title>群组管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/conversations" v-permission="'conversation:read'">
            <el-icon><ChatLineSquare /></el-icon>
            <template #title>会话管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/channels" v-permission="'channel:read'">
        ...
        <el-sub-menu index="app-group">
          ...
          <el-menu-item index="/admin/apps" v-permission="'app:read'">
            <el-icon><Monitor /></el-icon>
            <template #title>应用管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/mini-apps" v-permission="'miniapp:read'">
            <el-icon><Cellphone /></el-icon>
            <template #title>小程序管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/ai-assistant" v-permission="'ai:read'">
            <el-icon><Cpu /></el-icon>
            <template #title>AI 助手</template>
          </el-menu-item>
          <el-menu-item index="/admin/ai-ops" v-permission="'ai:read'">
            <el-icon><Monitor /></el-icon>
            <template #title>AI 运维面板</template>
          </el-menu-item>
          <el-menu-item index="/admin/ai-config" v-permission="'ai:read'">
            <el-icon><Setting /></el-icon>
            <template #title>AI 模型配置</template>
          </el-menu-item>
          <el-menu-item index="/admin/mcp-tools" v-permission="'ai:read'">
            <el-icon><Tools /></el-icon>
            <template #title>MCP 工具管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/knowledge-graph" v-permission="'ai:read'">
            <el-icon><Connection /></el-icon>
            <template #title>知识图谱</template>
          </el-menu-item>
          <el-menu-item index="/admin/vector-data" v-permission="'ai:read'">
            <el-icon><DataAnalysis /></el-icon>
            <template #title>向量数据</template>
          </el-menu-item>
          <el-menu-item index="/admin/approvals" v-permission="'ai:read'">
        ...
        <el-sub-menu index="msg-group">
          ...
          <el-menu-item index="/admin/messages" v-permission="'message:read'">
            <el-icon><ChatDotRound /></el-icon>
            <template #title>系统消息</template>
          </el-menu-item>
          <el-menu-item index="/admin/message-search" v-permission="'message:read'">
            <el-icon><Search /></el-icon>
            <template #title>消息搜索</template>
          </el-menu-item>
          <el-menu-item index="/admin/notifications" v-permission="'notification:read'">
        ...
        <el-sub-menu index="security-group">
          ...
          <el-menu-item index="/admin/blacklist" v-permission="'blacklist:read'">
            <el-icon><CircleCloseFilled /></el-icon>
            <template #title>黑名单管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/sensitive-words" v-permission="'sensitive:read'">
            <el-icon><Warning /></el-icon>
            <template #title>敏感词管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/operation-logs" v-permission="'log:read'">
        ...
        <el-sub-menu index="system-group">
          ...
          <el-menu-item index="/admin/system-config" v-permission="'config:read'">
            <el-icon><Tools /></el-icon>
          ...
          <el-menu-item index="/admin/file-storage" v-permission="'file:read'">
            <el-icon><Folder /></el-icon>
            <template #title>文件存储管理</template>
          </el-menu-item>
          <el-menu-item index="/admin/server-monitor" v-permission="'monitor:read'">
            <el-icon><Monitor /></el-icon>
