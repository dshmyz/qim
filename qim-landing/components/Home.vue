  ...
  <div class="landing-page">
    ...
    <header class="top-nav">
      <div class="top-nav-inner">
        <div class="top-nav-brand" @click="scrollToTop">
          <img src="/app-logo-v1.png" :alt="productName" class="top-nav-logo" />
          <span class="top-nav-name">{{ productName }}</span>
        </div>
    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <div class="hero-actions">
          <button class="btn btn-secondary" @click="scrollToFeatures">了解更多</button>
          <button class="btn btn-primary" @click="downloadClient">
    ...
    <section class="dev-docs" id="dev-docs">
      ...
      <div class="dev-docs-grid">
        ...
        <a href="/docs/mcp" class="doc-card">
...
const scrollToDevDocs = () => {
  document.getElementById('dev-docs')?.scrollIntoView({ behavior: 'smooth' })
}
...
const downloadClient = () => {
  ...
  if (!platform || platform.downloads.length === 0) {
    alert('暂无可用版本，请联系管理员在版本管理中发布对应平台的安装包')
    return
  }
